...
class LMDA1(nn.Module):
    def __init__(self, classification, chans=12, samples=1921, num_classes=2, depth=9, kernel=75, channel_depth1=24,
                 channel_depth2=9, ave_depth=1, avepool=5):
        super(LMDA1, self).__init__()
