...
class EEGNet_ATTEN(nn.Module):
    def __init__(self, Chans,kernLength1,kernLength2,kernLength3,F1,D,classification_num, DOR): # DOR adjustable for generation of sub-networks
        ...
        D = D
        F2 = F1 * D
        self.classification = target_classifier(classification_num)
...
if __name__ == '__main__':
    model = EEGNet_ATTEN(Chans=22,kernLength1=36,kernLength2=24,kernLength3=18,F1=16,D=2,classification_num=4,DOR=0.5).cuda()
