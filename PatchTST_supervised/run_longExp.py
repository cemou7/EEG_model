...
if __name__ == '__main__':
    ...
    parser.add_argument('--enc_in', type=int, default=22, help='encoder input size') # DLinear with --individual, use this hyperparameter as the number of channels
    parser.add_argument('--dec_in', type=int, default=7, help='decoder input size')
    parser.add_argument('--c_out', type=int, default=7, help='output size')

    parser.add_argument('--d_model', type=int, default=512, help='dimension of model')  # D
    ...
    if args.is_training:
        for ii in range(1):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(
                ...
                args.d_model,       # 512   dimension of model(D)
                ...
                args.distil,        # True  not using distilling
                args.des, ii)
