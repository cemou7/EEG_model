...
def get_dls(params):
    ...
    if params.dset == 'ettm1':
        ...
        root_path = 'data/ETT/'
        size = [params.context_points, 0, params.target_points]     # [512, 0, 96], sequence length, forecast horizon
        dls = DataLoaders(
    ...
    # dataset is assume to have dimension len x nvars   (512, 7)
    dls.vars, dls.len = dls.train.dataset[0][0].shape[1], params.context_points
    dls.c = dls.train.dataset[0][1].shape[0]    # pred, target_points: 96
    return dls
