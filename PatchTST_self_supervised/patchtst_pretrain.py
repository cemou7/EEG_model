...
parser.add_argument('--context_points', type=int, default=1000, help='sequence length')
parser.add_argument('--target_points', type=int, default=500, help='forecast horizon')
...
# Patch
parser.add_argument('--patch_len', type=int, default=50, help='patch length')       # all  42  patch
