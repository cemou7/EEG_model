...
class DataLoaders:
    def __init__(
        ...
        self.collate_fn = collate_fn    # None
        self.shuffle_train, self.shuffle_val = shuffle_train, shuffle_val   # True, False
    
        self.train = self.train_dataloader()    # 126 * 64
        self.valid = self.val_dataloader()      # 44
        self.test = self.test_dataloader()      # 44
